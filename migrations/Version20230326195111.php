 ...
 */
final class Version20230326195111 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE lift (id INT AUTO_INCREMENT NOT NULL, station_id INT NOT NULL, name VARCHAR(255) NOT NULL, first_hour TIME NOT NULL, last_hour TIME NOT NULL, exception TINYINT(1) DEFAULT NULL, exception_message VARCHAR(255) DEFAULT NULL, duration TIME NOT NULL, type VARCHAR(255) DEFAULT NULL, peak_hour DATETIME DEFAULT NULL, comfort INT DEFAULT NULL, INDEX IDX_737D1E0C21BDB235 (station_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE slope (id INT AUTO_INCREMENT NOT NULL, station_id INT NOT NULL, name VARCHAR(255) NOT NULL, difficulty INT NOT NULL, first_hour TIME NOT NULL, last_hour TIME NOT NULL, exception TINYINT(1) DEFAULT NULL, exception_message VARCHAR(255) DEFAULT NULL, duration TIME NOT NULL, peak_hour DATETIME DEFAULT NULL, snow_quality INT DEFAULT NULL, type VARCHAR(255) NOT NULL, INDEX IDX_58CC458521BDB235 (station_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE station (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, domain_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, icon_url VARCHAR(255) DEFAULT NULL, weather VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, notation INT DEFAULT NULL, INDEX IDX_9F39F8B17E3C61F9 (owner_id), INDEX IDX_9F39F8B1115F0EE5 (domain_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
