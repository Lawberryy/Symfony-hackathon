 ...
 */
final class Version20230322115001 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE link_trail (id INT AUTO_INCREMENT NOT NULL, trail_id INT NOT NULL, lift_id INT DEFAULT NULL, slope_id INT DEFAULT NULL, position INT NOT NULL, INDEX IDX_1DD3D9515BD41EB6 (trail_id), INDEX IDX_1DD3D951928C351B (lift_id), INDEX IDX_1DD3D95175260E2F (slope_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE trail (id INT AUTO_INCREMENT NOT NULL, total_duration TIME NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE link_trail ADD CONSTRAINT FK_1DD3D9515BD41EB6 FOREIGN KEY (trail_id) REFERENCES trail (id)');
        $this->addSql('ALTER TABLE link_trail ADD CONSTRAINT FK_1DD3D951928C351B FOREIGN KEY (lift_id) REFERENCES lift (id)');
        $this->addSql('ALTER TABLE link_trail ADD CONSTRAINT FK_1DD3D95175260E2F FOREIGN KEY (slope_id) REFERENCES slope (id)');
